...
const kShadowColor = Color(0xFF364564);
  ...
  const Color backColor = Color(0xFF494E52);
  const Color plateColor = Color(0xFF33383C);
  const Color cardColor = Color(0xFF2D3035);
  const Color orangeTextColor = Color(0xFFF1A348);